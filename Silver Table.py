...
# Check the distribution in the original, training, validation, and testing sets
...
check_distribution(silver_df, selected_columns)

print("Training Data Distribution:")
check_distribution(train_df, selected_columns)

print("Validation Data Distribution:")
check_distribution(val_df, selected_columns)

print("Testing Data Distribution:")
check_distribution(test_df, selected_columns)

# Save the training, validation, and testing sets as tables (optional)
train_df.write.format("delta").mode("overwrite").saveAsTable("mhcld_bronze_train")
val_df.write.format("delta").mode("overwrite").saveAsTable("mhcld_bronze_val")
test_df.write.format("delta").mode("overwrite").saveAsTable("mhcld_bronze_test")
